    ...
    <header className="flex items-center justify-between whitespace-nowrap border-b border-gray-200 dark:border-gray-800 px-10 py-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-2">
          <button className="flex items-center justify-center rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold transition-colors hover:scale-105">
            <span>Sign Up</span>
          </button>
          <button className="flex items-center justify-center rounded-lg h-10 px-4 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 text-sm font-bold transition-colors hover:bg-gray-200 dark:hover:bg-gray-700 scale-105">
            <span>Login</span>
          </button>
        </div>
      </div>
